return {
...

  {
    ...
    opts = {
      ...
      ignored_filetypes = { "TelescopePrompt", "Trouble", "help", "dashboard", "neo-tree-popup", "gitcommit" },
    ...
    config = function(_, opts)
      local whitespaces_nvim = require("whitespace-nvim")
      whitespaces_nvim.setup(opts)

      vim.keymap.set("n", "<Leader>t", whitespaces_nvim.trim, { desc = "Trim trailing whitespace" })
    end,
  },
  ...
  -- linting with nvim-lint
  {
    ...
    config = function()
      ...
      if VENV then
        ...
        if pylint then
          pylint.cmd = bin_path .. pylint.cmd
        end
      end
    end,
  },
